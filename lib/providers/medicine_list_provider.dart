// providers/medicine_selection_provider.dart
import 'package:flutter/foundation.dart';

class MedicineSelectionProvider with ChangeNotifier {
  List<Medicine> _selectedMedicines = [];

  List<Medicine> get selectedMedicines => _selectedMedicines;

  void addMedicine(Medicine medicine) {
    if (!_selectedMedicines.any((m) => m.medicineId == medicine.medicineId)) {
  ...
  bool isMedicineSelected(Medicine medicine) {
    return _selectedMedicines.any((m) => m.medicineId == medicine.medicineId);
  }

  void setSelectedMedicines(List<Medicine> medicines) {
    _selectedMedicines = List<Medicine>.from(medicines);
    notifyListeners();
  }
}
